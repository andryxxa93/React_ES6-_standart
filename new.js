...
// });
// employersNames = employersNames.map((names) => names.toLowerCase().trim());
...
const sumSponsors = [...eu, ...rus, 'unepected sponsors'];

const calcSach = ((cash = 0) => cash.reduce((a, b) => a + b));

const money = calcSach(cash);
